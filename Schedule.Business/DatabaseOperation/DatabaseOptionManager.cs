...
using Schedule.Business.Constants;
...
namespace Schedule.Business.DatabaseOperation
{
    public class DatabaseOptionManager : IDatabaseOptionService
    {
        ...
        {
            string commandText = string.Format(DatabaseConstants.BackupCommandText, _databaseOptionDto.DatabaseName, _databaseOptionDto.BackupPath, _databaseOptionDto.DatabaseName);
        ...
        {
            string commandText = string.Format(DatabaseConstants.RestoreCommandText,
